...
import com.baidu.duer.files.databinding.FilePropertiesTabFragmentBinding
import com.baidu.duer.files.databinding.FilePropertiesTabItemBinding
...
abstract class FilePropertiesTabFragment : Fragment() {
    ...
    protected inline fun <T> bindView(stateful: Stateful<T>, block: ViewBuilder.(T) -> Unit) {
        ...
        if (!(stateful is Loading && hasValue)) {
