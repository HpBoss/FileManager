package com.baidu.duer.files.provider.document.resolver
...
import com.baidu.duer.files.provider.content.resolver.*
import com.baidu.duer.files.util.AbstractLocalCursor
