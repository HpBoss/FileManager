...
import com.baidu.duer.files.compat.ProxyFileDescriptorCallbackCompat
import com.baidu.duer.files.compat.openProxyFileDescriptorCompat
import com.baidu.duer.files.provider.common.*
import com.baidu.duer.files.provider.document.documentUri
...
import com.baidu.duer.files.util.withoutPenaltyDeathOnNetwork
...
val Path.fileProviderUri: Uri
    get() {
        ...
        return FileProvider.getUriForFile(
            application,
            BuildConfig.URI_PROVIDIER_AUTHORITY,
            File(this.toString())
        )
    }
