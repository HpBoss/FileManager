...
import com.baidu.duer.files.compat.getMimeTypeFromExtensionCompat
import com.baidu.duer.files.provider.common.PosixFileType
import com.baidu.duer.files.util.asFileName
import com.baidu.duer.files.util.asPathName
