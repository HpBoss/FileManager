...
import com.baidu.duer.files.compat.EnvironmentCompat2
import com.baidu.duer.files.filelist.FileSortOptions
import com.baidu.duer.files.filelist.OpenApkDefaultAction
import com.baidu.duer.files.navigation.BookmarkDirectory
import com.baidu.duer.files.navigation.StandardDirectorySettings
import com.baidu.duer.files.provider.root.RootStrategy
import com.baidu.duer.files.storage.FileSystemRoot
import com.baidu.duer.files.storage.PrimaryStorageVolume
...
object Settings {
    val STORAGES: SettingLiveData<List<Storage>> =
        ParcelValueSettingLiveData(
            ...
            listOf(
                FileSystemRoot(null, false),
                PrimaryStorageVolume(application.getString(R.string.storage_all_file_title), true)
            )
        )
