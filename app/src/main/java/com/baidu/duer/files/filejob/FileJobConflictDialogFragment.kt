...
import com.baidu.duer.files.coil.AppIconPackageName
import com.baidu.duer.files.compat.requireViewByIdCompat
import com.baidu.duer.files.databinding.FileJobConflictDialogViewBinding
import com.baidu.duer.files.file.*
import com.baidu.duer.files.filelist.appDirectoryPackageName
...
class FileJobConflictDialogFragment : AppCompatDialogFragment() {
    ...
    /** @see com.baidu.duer.files.filelist.FileListAdapter.onBindViewHolder */
