...
import com.baidu.duer.files.databinding.EditFtpServerFragmentBinding
import com.baidu.duer.files.provider.ftp.client.Authority
import com.baidu.duer.files.provider.ftp.client.Mode
import com.baidu.duer.files.provider.ftp.client.Protocol
